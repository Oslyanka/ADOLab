...
{
    /// <summary>
    /// Obt�m ou define a string de conexão com o banco de dados.
    /// </summary>
    ...
    /// <returns>O ID da entidade rec�m-inserida.</returns>
    ...
    /// </summary>
    /// <param name="id">O ID da entidade a ser exclu�da.</param>
    /// <returns>O n�mero de linhas afetadas.</returns>
    int Excluir(int id);
